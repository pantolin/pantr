...
from pantr.basis import eval_cardinal_Bspline_basis_1D
...
class TestCardinalBspline:
    ...
    def test_degree_two_doc_example(self, dtype: npt.DTypeLike) -> None:
        ...
        res = eval_cardinal_Bspline_basis_1D(2, pts)
        exp = np.array(
            [
                [0.5, 0.5, 0.0],
                [0.125, 0.75, 0.125],
    ...
    def test_partition_of_unity_on_span(self, degree: int, dtype: npt.DTypeLike) -> None:
        ...
        res = eval_cardinal_Bspline_basis_1D(degree, pts)
    ...
    def test_dtype_preservation(self) -> None:
        ...
        assert eval_cardinal_Bspline_basis_1D(3, pts32).dtype == np.float32
        assert eval_cardinal_Bspline_basis_1D(3, pts64).dtype == np.float64
